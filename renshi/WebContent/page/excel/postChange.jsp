...
<body>
	...
	<form action="${pageContext.request.contextPath }/ExcelPostServlet" method = "post">
		<div class="text-c">
...
    				<span><input type="checkbox" value="姓名#empname" name="export" checked="checked"></span>
			...
			<td>
				<div>
    				<span><input type="checkbox" value="旧岗位#oldpost" name="export" checked="checked"></span>
 					<input type="text" value="旧岗位" disabled="disabled">
				</div>
			</td>
			<td>
				<div>
    				<span><input type="checkbox" value="新岗位#newpost" name="export" checked="checked"></span>
 					<input type="text" value="新岗位" disabled="disabled">
				</div>
			</td>
			<td>
				<div>
