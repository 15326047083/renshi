...
/**
 * Servlet implementation class FindEmpPostServlet
 */
public class FindEmpPostServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("emp_id") != ""){
			...
			if(emp != null){
				...
				response.sendRedirect("page/change/findemppost.jsp?num=1");
			}
			else{
				response.sendRedirect("page/change/findemppost.jsp?num=0");//不存在
			}
