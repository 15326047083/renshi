...
/**
 * Servlet implementation class ExcelQuitServlet
 */

public class ExcelQuitServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Emp> list = es.selectQuitService(dept, start, end);
		try {
		ExportExcelUtil.export(response, "离职员工报表", excelHeader, list);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
